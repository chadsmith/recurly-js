...
module.exports = function(config) {
  ...
  this.invoices = {
    ...
    listByAccount: function(accountcode, filter, callback) {
      ...
      t.request(utils.addParams(utils.addQueryParams(routes.invoices.listByAccount, filter), {
        account_code: accountcode
      }), callback);
    },
  ...
  this.planAddons = {
    ...
    update: function(plancode, addoncode, details, callback) {
      t.request(utils.addParams(routes.planAddons.update, {
        plan_code: plancode,
  ...
  this.purchases = {
    ...
    authorize: function(details, callback) {
      t.request(routes.purchases.authorize, callback, js2xmlparser('purchase', details));
    },
    pending: function(details, callback) {
      t.request(routes.purchases.pending, callback, js2xmlparser('purchase', details));
    },
    capture: function(uuid, callback) {
      t.request(utils.addParams(routes.purchases.capture, {
        transaction_uuid: uuid
      }), callback);
    },
    cancel: function(uuid, callback) {
      t.request(utils.addParams(routes.purchases.cancel, {
        transaction_uuid: uuid
      }), callback);
    },
  };
  ...
  this.subscriptions = {
    ...
    listByAccount: function(accountcode, filter, callback) {
      ...
      t.request(utils.addParams(utils.addQueryParams(routes.subscriptions.listByAccount, filter), {
        account_code: accountcode
      }), callback);
    },
    get: function(uuid, callback) {
  ...
  this.transactions = {
    ...
    listByAccount: function(accountCode, filter, callback) {
      ...
      t.request(utils.addParams(utils.addQueryParams(routes.transactions.listByAccount, filter), {
        account_code: accountCode
      }), callback);
    },
