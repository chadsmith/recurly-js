...
exports.purchases = {
  ...
  authorize: ['/v2/purchases/authorize', 'POST'],
  pending: ['/v2/purchases/pending', 'POST'],
  capture: ['/v2/purchases/transaction-uuid-:transaction_uuid/capture', 'POST'],
  cancel: ['/v2/purchases/transaction-uuid-:transaction_uuid/cancel', 'POST'],
};
